Bluetooth Low Energy interface for minew E-8 beacon project 
...
The code is tested on Python 3.8 and should work on 3.8 or later version
...
[Service]
Type=forking
ExecStart=/home/pi/ble-accelerometer/textlog/launch_blescanner.sh
